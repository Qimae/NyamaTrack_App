    ...
    case 'POST':
        ...
        try {
            ...
            $checkStmt = $pdo->prepare("
                SELECT id FROM goat_transactions 
            ...
            if ($success) {
                ...
                $stmt = $pdo->prepare("SELECT * FROM goat_transactions WHERE id = ?");
    ...
    case 'DELETE':
        ...
        try {
            ...
            try {
                ...
                $deleteStmt = $pdo->prepare("DELETE FROM goat_transactions WHERE id = ?");

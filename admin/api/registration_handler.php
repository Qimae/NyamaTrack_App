<?php
// admin/registration_handler.php
// Handles admin registration form input
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkStmt = $pdo->prepare("SELECT id FROM admin_users WHERE email_hash = ? LIMIT 1");
    $checkStmt->execute([$hash_email]);
    if ($checkStmt->fetch()) {

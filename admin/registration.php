...
<head>
    ...
    <title>Nyamatrack - Admin Register | Premium Butchery Management</title>
...
<body class="gradient-bg min-h-screen flex items-center justify-center relative overflow-hidden py-8">
    ...
    <div class="register-container w-full max-w-lg mx-auto p-4 relative z-10">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-400 text-sm">Admin Registration - Access the Butchery Management System</p>
        </div>
        ...
        <div class="glass-card rounded-2xl p-6 shadow-2xl">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-400 text-sm">Get full control over admin operations.</p>
            </div>
            ...
            <form id="registerForm" method="POST" class="flex-1 flex flex-col">
                ...
                <!-- Step 2: Security and Business Information -->
                <!-- Step 2: Security -->
                    ...
                    <div class="space-y-3 mt-4">
                        <label class="flex items-start">
                            ...
                            <span class="ml-2 text-sm text-gray-300">
                                I agree to the <a href="#" class="text-gray-400 hover:text-white underline">Terms of Service</a> and 
                                <a href="#" class="text-gray-400 hover:text-white underline">Privacy Policy</a>
                            </span>
                        </label>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center pt-4 mt-auto">
                    ...
                    <div class="flex space-x-2">
                        <button type="button" id="nextBtn"
                            class="glow-button px-6 py-2 rounded-lg text-white font-semibold transition-all duration-300 hover:scale-105"
                            onclick="changeStep(1)">
                            Next<i class="fas fa-arrow-right ml-2"></i>
                        </button>
                        <button type="submit" id="submitBtn"
                            class="glow-button px-6 py-2 rounded-lg text-white font-semibold transition-all duration-300 hover:scale-105 hidden">
                ...
                <div class="text-center mt-4">
                    <p class="text-gray-400 text-sm">
                        ...
                        <a href="index.php" class="text-gray-300 hover:text-white font-semibold transition-colors">
                            Sign In
                        </a>
                    </p>
                </div>

                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-800">
                                <th class="text-left text-orange-400 font-semibold py-3">ID</th>
                        ...
                        <tbody>
                            <!-- Sample Admin Employee Row -->
                            <tr class="border-b border-gray-800 hover:bg-gray-800/30">
                                <td class="py-4 font-medium text-white">ADM001</td>
                                <td class="py-4 text-gray-300">John Doe</td>
                                <td class="py-4 text-gray-300">john@nyamatrack.co.ke</td>
                                <td class="py-4">
                                ...
                                <td class="py-4">
                                    <div class="flex gap-2">
                                        <button class="text-blue-400 border-none hover:text-blue-300 hover:bg-gray-800 px-2 py-1 rounded">
                                            Edit
                                        </button>
                                        <button class="text-red-400 border-none hover:text-red-300 hover:bg-gray-800 px-2 py-1 rounded">
                                            Deactivate
                                        </button>
                                    </div>
                                </td>
